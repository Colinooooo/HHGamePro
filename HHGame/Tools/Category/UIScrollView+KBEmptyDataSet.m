...
#import "UIScrollView+KBEmptyDataSet.h"
...
@implementation UIScrollView (KBEmptyDataSet)
...
- (UIImage *)imageForEmptyDataSet:(UIScrollView *)scrollView {
    return self.emptyImage?:[UIImage imageNamed:@"占位图片"];
}
